...
function ContactUs() {
  return (
    <form>
      <section id="contactus" className="mt-5 ppt">
        <div className="container">
          <div className="row">
            <div className="col-sm-12">
              ...
              <div className="p-5 ppr" style={{ background: "#EAEAEA" }}>
                <form>
                  <div className="form-row">
                    ...
                    <div className="col-sm-12 col-lg-6">
                      ...
                      <button
                        className="btn btn-primary btn-block text-dark border rounded border-light"
                        type="submit"
